...
public class SecurityConfiguration {
    ...
    public SecurityConfiguration(CustomBasicAuthenticationEntryPoint customBasicAuthenticationEntryPoint, CustomBearerTokenAuthenticationEntryPoint customBearerTokenAuthenticationEntryPoint, CustomBearerTokenAccessDeniedHandler customBearerTokenAccessDeniedHandler) throws NoSuchAlgorithmException {
        ...
        keyPairGenerator.initialize(2048); // The generate key will have a size of 2048 bits.
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                .authorizeHttpRequests(authorizeHttpRequest -> authorizeHttpRequest
                        ...
                        .requestMatchers(HttpMethod.GET, this.baseUrl + "/users/**").hasAnyAuthority("ROLE_admin")//Protect the endpoint.
    ...
    public JwtAuthenticationConverter jwtAuthenticationConverter() {
        ...
        jwtGrantedAuthoritiesConverter.setAuthoritiesClaimName("authorities"); //tell spring that get authorities from claims name "authorities"
        jwtGrantedAuthoritiesConverter.setAuthorityPrefix(""); //not add SCOPE in the front of the ROLE_
